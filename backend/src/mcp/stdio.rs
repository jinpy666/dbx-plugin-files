...
pub(crate) fn inline_connection_properties() -> Value {
    ...
    "bucket": { "type": "string", "description": "Bucket (s3/gcs/obs/oss/cos/qiniu); optional on s3/oss/obs/cos/qiniu — leave empty to list all buckets at the connection root" },
    ...
    "endpoint": { "type": "string", "description": "Endpoint URL (s3/gcs/azblob/obs/oss/cos/qiniu)" },
    "accessKeyId": { "type": "string", "description": "Access key id (s3/obs/oss/qiniu)" },
    "secretAccessKey": { "type": "string", "description": "Secret access key (s3/obs/oss/qiniu; stays in process memory only)" },
