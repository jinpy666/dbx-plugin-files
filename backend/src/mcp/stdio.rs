...
pub(crate) fn inline_connection_properties() -> Value {
    ...
    "region": { "type": "string", "description": "Region (s3/oss; pinned to auto for r2)" },
    "endpoint": { "type": "string", "description": "Endpoint URL (s3/gcs/azblob/obs/oss/cos/qiniu and the S3-compatible vendor protocols r2/wasabi/spaces/scaleway/idrive/us3/ecloud/nos/bos/tos/ks3)" },
    "accessKeyId": { "type": "string", "description": "Access key id (s3/obs/oss/qiniu and the S3-compatible vendor protocols)" },
    "secretAccessKey": { "type": "string", "description": "Secret access key (s3/obs/oss/qiniu and the S3-compatible vendor protocols; stays in process memory only)" },
    ...
    "displayCharset": { "type": "string", "description": "FTP filename display charset: gbk/big5/shift_jis/windows-1252 (ftp; empty = UTF-8)" },
