...
/// Re-exported so sibling test modules (appbridge::tests) can share the
/// process-global env serialization lock while it lives in `tests.rs`.
#[cfg(test)]
use tests::BRIDGE_ENV_LOCK;
