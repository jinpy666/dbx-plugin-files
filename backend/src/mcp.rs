...
fn stored_connection_from_inline(connection: &Value) -> Result<StoredConnection, String> {
    ...
    for (inline_key, config_key) in [
        ...
        ("authType", "auth_type"),
        ("nameNode", "name_node"),
        ("kerberosTicketCachePath", "kerberos_ticket_cache_path"),
        ("email", "email"),
        ...
        ("enableHns", "enable_hns"),
        ("blockSize", "block_size"),
        ("chunkSize", "chunk_size"),
        ("writeType", "write_type"),
        ("enableAppend", "enable_append"),
        ("atomicWriteDir", "atomic_write_dir"),
        ("enableVersioning", "enable_versioning"),
        ("tempUrlHashAlgorithm", "temp_url_hash_algorithm"),
        ("disableConfigLoad", "disable_config_load"),
        ("skipSignature", "skip_signature"),
        ("disableListBatch", "disable_list_batch"),
    ] {
...
fn inline_connection_properties() -> Value {
    ...
    "protocol": { "type": "string",
        "description": "Storage protocol (required): local (alias of fs), fs, s3, oss, cos, webdav, ftp, sftp, smb, sftp-native, aliyun-drive, alluxio, azdls, azfile, b2, compfs, dbfs, dropbox, gdrive, ghac, github, goosefs, hdfs, hdfs-native, http, ipfs, ipmfs, koofr, lakefs, monoiofs, onedrive, pcloud, seafile, swift, tos, upyun, vercel-artifacts, vercel-blob, webhdfs, yandex-disk, opendal-custom" },
    ...
    "applicationKeyId": { "type": "string" },
    "version": { "type": "string" },
    "owner": { "type": "string" },
    "repo": { "type": "string" },
    "masterAddr": { "type": "string" },
    "authUsername": { "type": "string" },
    "authType": { "type": "string" },
    "nameNode": { "type": "string" },
    "kerberosTicketCachePath": { "type": "string" },
    "email": { "type": "string" },
    ...
    "enableHns": { "type": "boolean" },
    "blockSize": { "type": "string" },
    "chunkSize": { "type": "string" },
    "writeType": { "type": "string" },
    "enableAppend": { "type": "boolean" },
    "atomicWriteDir": { "type": "string" },
    "enableVersioning": { "type": "boolean" },
    "tempUrlHashAlgorithm": { "type": "string" },
    "disableConfigLoad": { "type": "boolean" },
    "skipSignature": { "type": "boolean" },
    "disableListBatch": { "type": "boolean" },
...
mod tests {
    ...
    fn manifest_fields_are_fully_covered_by_inline_mapping() {
        ...
        let config_map: &[(&str, &str)] = &[
            ...
            ("name_node", "nameNode"),
            ("kerberos_ticket_cache_path", "kerberosTicketCachePath"),
            ("enable_append", "enableAppend"),
            ("atomic_write_dir", "atomicWriteDir"),
            ("user_name", "userName"),
            ("disable_list_batch", "disableListBatch"),
            ("email", "email"),
            ("repository", "repository"),
            ("branch", "branch"),
            ("repo_name", "repoName"),
            ...
            ("container", "container"),
            ("temp_url_hash_algorithm", "tempUrlHashAlgorithm"),
            ("disable_config_load", "disableConfigLoad"),
